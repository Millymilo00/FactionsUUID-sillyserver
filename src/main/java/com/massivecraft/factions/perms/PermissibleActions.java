...
public enum PermissibleActions implements PermissibleAction {
    ...
    WAR(TL.PERM_WAR, TL.PERM_SHORT_WAR, "IRON_SWORD"),
    WAR_LIST(TL.PERM_WAR_LIST, TL.PERM_SHORT_WAR_LIST, "MAP"),
    WAR_NAG(TL.PERM_WAR_NAG, TL.PERM_SHORT_WAR_NAG, "MAGMA_CREAM")
    ;
